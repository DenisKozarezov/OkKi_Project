...
|--|--|--|--|
| РП (Владелец продукта) | Бизнес-результат, решение проблем, обеспечение ресурсами | ❓[Козарезов Денис](https://github.com/DenisKozarezov) | ❓[ФИО 2]()
| АД (Мастер) | Диспетчирование и контроль задач, выявление проблем| ❓[Петруша Анна]() | ❓[ФИО 2]()
| СП (Аналитик) | Сбор и управление всеми требованиями в проекте| ❓[Крупенко Илья](https://github.com/Kolyamba2007) | ❓[ФИО 2]()
| ВН (Дизайнер)	| Удобство использования, привлекательность продукта| ❓[Жикина Валерия]() | ❓[ФИО 2]()
| БА (Тестировщик) | Выявление бизнес-проблем, способы тестирования| ❓[Мавлоназаров Хушнуд]() | ❓[ФИО 2]()
| НИ (Архитектор) | Структура продукта, инструменты разработки и поставки| ❓[Салип Даниил](https://github.com/Welpodron) | ❓[ФИО 2]()
| ПП (Программист) | Стиль и способы разработки, используемые фреймворки| ❓[Крючков Павел](https://github.com/bagofpockets) | ❓[ФИО 2]()
| КО (Тех.писатель) | Документирование проекта и продукта| ❓[Парфёнова Анастасия]() | ❓[ФИО 2]()
